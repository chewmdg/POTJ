    ...
    static class Jedi_Utility
    {
        ...
        public static int GetAfterArmorDamage(Pawn pawn, int damAmountInt, BodyPartRecord part, DamageInfo dinfo, bool damageArmor, ref bool deflected)
        {
            ...
            if (dinfo.WeaponGear != null)
            {
                ...
                {
                    ProjectilePropertiesJedi projectileProps = dinfo.WeaponGear.Verbs.Find(s => s.projectileDef != null).projectileDef.projectile as ProjectilePropertiesJedi;
